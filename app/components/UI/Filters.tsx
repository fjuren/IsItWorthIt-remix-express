    ...
    >
      ...
      <fieldset>
        ...
        <div className="space-y-2 mt-2">
          ...
          <div>
            <Slider
              id="recentSales"
              value={[parseInt(minPriceFromRange), parseInt(maxPriceFromRange)]}
      ...
      <fieldset>
        ...
        <div className="space-y-2 mt-2">
          <div className="space-x-2">
            <div className="space-x-2">
              <Label htmlFor="steamRating">Minimum Steam User Rating (%)</Label>
              {/* <span className="text-sm italic">
                Only include games where at least this percentage of Steam user
          ...
          <div className="space-x-2">
            ...
            <div>
              <Slider
                ...
                onValueChange={([val]) => setMetacriticRatings(val.toString())}
                min={0}
                max={100}
                step={1}
              />
